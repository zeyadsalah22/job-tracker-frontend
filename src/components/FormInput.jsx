    ...
    <div className="relative z-0 flex flex-col">
      ...
      {props.textarea ? (
        <textarea
          ...
          } h-28 max-h-48 w-full resize-none overflow-y-auto rounded-md border px-4 py-3 focus:border-blue-500 focus:ring-blue-500`}
        />
      ) : (
        <input
          name={props.name}
          ...
          className={`${
            props.touched && props.error && "border-red-500 ring-red-500"
          } w-full rounded-md border px-4 py-2 focus:border-blue-500 focus:ring-blue-500`}
        />
      )}
